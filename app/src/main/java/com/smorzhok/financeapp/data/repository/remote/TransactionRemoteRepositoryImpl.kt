...
class TransactionRemoteRepositoryImpl @Inject constructor(
    ...
    override suspend fun createTransaction(transaction: Transaction) = withContext(Dispatchers.IO) {
        api.createTransaction(transaction.toTransactionRequest())
    }

    override suspend fun getTransactionById(id: Int): TransactionEdit = withContext(Dispatchers.IO) {
